 ...
 * The things added are spaces, punctuation, lowercase, and uppercase will 
 * not be considered when the program is determining a string is
...
public class PalindromeTester {
    ...
    public static void main(String[] args) {
        ...
        while (another.equalsIgnoreCase("y")) {
            ...
            // Comparing each character from the very left and very right.
